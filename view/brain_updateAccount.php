            ...
            <div class="collapsible-header "><i class="tiny glyphicon glyphicon-user circle" id="mn_cat"></i> <b>USERS</b></div>
              <div class="collapsible-body">
                  <ul>
                    ...
                    <li class="divider"></li>
                    <a href="#!" id="list2" class="center waves-effect waves-light btn transparent"><i class="glyphicon glyphicon-wrench" id="mn_cat"></i> User Update</a>                 
  ...
  <?php } ?>
      ...
      <div class="container" >
          <div class="row">
             ...
             <input type="hidden" name="action" value="brain_UpdateUser">
             <input type="hidden" name="user_id" value="<?= $brain_users->getUser_id();  ?>">
               
            <div class="col s12 offset-s1 grid-example " id="form-bottom">
            <div class="white-text blue col s6 grid-example center z-depth-2" id="list_users"><span class="flow-text" id="h_list"><i class="glyphicon glyphicon-user"></i> Edit My Account:</span></div>
               ...
               <div class="row">
                   ...
                   <div class="col s3 ">
                         ...
                         <h6><?= $brain_users->getUsertype(); ?></h6>
                              <img alt="Brand" class="z-depth-3 img-responsive" src="<?= $brain_users->getAcc_path(); ?>" width="220" height="350" id="inputs">
                      <script>
                        var loadFile = function(event) {
                         ...
                         <div class="fileUpload col s6 offset-s3 grid-example ">
                              ...
                              <input type="file" class="upload" value="<?= $brain_users->getAcc_path(); ?>" name="acc_name"  accept="image/*" onchange="loadFile(event)">
                          </div>
                    </div>
                    ...
                    <div class="input-field col s4">
                      <input  value="<?= $brain_users->getLname(); ?>" length="30" name="lastname" type="text" id="last_name" class="validate" required>
                      <label for="last_name">Last Name:</label>
                    </div>

                      <div class="input-field col s4">
                        <input value="<?= $brain_users->getFname(); ?>" length="30" name="firstname" type="text" id="first_name"  class="validate" required>
                        <label for="first_name">First Name:</label>
                      </div>
                   
                      <div class="input-field col s4">
                        <input value="<?= $brain_users->getMname(); ?>" length="30" name="middlename" type="text" id="middle_name"  class="validate" required>
                        <label for="middle_name">Middle Name:</label>
                      </div>  

                       <div class="input-field col s6">
                        <input value="<?= $brain_users->getAddress(); ?>" length="50" name="address" type="text" id="address"  class="validate" required>
                        <label for="address">Address:</label>
                      </div>

                      <div class="input-field col s3">
                        <input value="<?= $brain_users->getContact(); ?>" length="30" name="contact" type="text" id="Contact"  class="validate" required>
                        <label for="bday">Contact:</label>
                      </div>

                      <div class="input-field col s3">
                        <input value="<?= $brain_users->getGender(); ?>" length="30" name="gender" type="text" id="gender"  class="validate" required>
                        <label for="gender">Gender:</label>
                      </div>

                       <div class="input-field col s3">
                        <input value="<?= $brain_users->getDob(); ?>" length="30" name="dob" class="datepicker" type="date" id="bday"  class="validate" required>
                        <label for="bday">Birthday:</label>
                      </div>

                      <div class="input-field col s3">
                        <input value="<?= $brain_users->getAge(); ?>" length="30" name="age" type="number" id="age"  class="validate" required>
                      ...
                      <div class="col s12">
                        ...
                        <hr>
                         <div class="input-field col s4">
                        <input value="<?= $brain_users->getUsername(); ?>" length="50" name="username" type="text" id="Contact"  class="validate" required>
                        <label for="bday">Username:</label>
                      </div>

                       <div class="input-field col s4">
                        <input value="<?= $brain_users->getPassword(); ?>" length="100" name="password" type="password" id="Contact"  class="validate" required>
                        <label for="bday">Password:</label>
                      </div>
                    ...
                    <div class="input-field col s12">
                           <button class="waves-effect waves-light btn blue right" type="Submit">Update</button>                          
                      </div>
                   </form>
        ...
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <button class="modal-action modal-close waves-effect waves-light btn red" title="Close"><i class="tiny glyphicon glyphicon-remove"></i></button>
            <a href="?user_id=<?= $brain_users->getUser_id();?>&action=brain_UpdateAccount" class="waves-effect waves-light btn blue" title="Edit or Update"><i class="glyphicon glyphicon-edit"></i></a>
          </div>
  </div>
    ...
    <div class="modal-content">
      <div class="col s12">
          ...
          <form action="." method="POST" enctype="multipart/form-data">
              ...
              <input type="hidden" name="locator" value="brain_UpdateAccount">
              <div class="row">
                    <div class="input-field col s3">
