<body>
 ...
 <?php } ?>
  ...
  <!--   <button data-type="time-remaining">Time Remaining</button>
    ...
    <h5 class=" header  white "><a href=".?action=brain_hard">English(Hard Mode)</a>  </h5>
    <h6>5 Points</h6>
     ...
     <label>Question: 1/5</label> 
          ...
          <p class="grey-text text-darken-3 lighten-3">
               <div class="row">
                ...
                <div 
                  id="quest"
                  class="animsition section white col s9 z-depth-3 red lighten-4" 
                 ...
                 <label><div id="countdown"></div></label>
                        <div class="row">
                              <div class="col s12 ">
                                  ...
                                  <h2>A Person who candidates more than 8 times in his candidacy inorder to become a U.S President</h2>
                      ...
                      <!--   <div class="row">
                            <div class="s12 m4 5">
                                <ul class="pagination left">                            
                                    ...
                                    <li class="active waves-effect " id="light-blue lighten-4"><a href="#!">2</a></li>
                                    <li class="waves-effect" id=" light-blue lighten-3"><a href="#!">3</a></li>
                            ...
                            <div class="s12 m4 10">
                                   <a class="btn-floating btn-large waves-effect waves-light dark-text amber darken-4  z-depth-2">HINT</a> <br>
                            </div>

                            <div class="s12 m4 5">  
                               <a class="btn-floating btn-large waves-effect waves-light gold z-depth-3 " id="buzz">Buzz</a>
                            </div>
                         ...
                         <div class="row">
                          ...
                          <div class="col s12 m7 13"><a class="btn-floating btn-large waves-effect waves-light dark-text amber darken-4  z-depth-2">HINT</a></div>
                          <div class="col s12 m7 l3">
                                 <a href=".?action=brain_result" class="btn-floating btn-large waves-effect waves-light gold z-depth-3 " id="buzz">Buzz</a>
                          </div>
                        </div>
                          <ul class="pagination left">                            
                                    <li class="waves-effect " id="dark-text light-blue lighten-5"><a href="#!">1</a></li>
                ...
                <label>Rankings</label>
                        <ul class="collection ">
                              <li class="collection-item avatar ">
                                ...
                                <a href="#!" class="secondary-content "><i class="material-icons">25</i></a>
                              </li>
                              ...
                              <li class="collection-item avatar  ">
                                ...
                                <a href="#!" class="secondary-content"><i class="material-icons">20</i></a>
                              </li>
                               <li class="collection-item avatar  ">
